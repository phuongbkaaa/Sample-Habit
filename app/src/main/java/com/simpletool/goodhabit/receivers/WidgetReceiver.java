...
public class WidgetReceiver extends BroadcastReceiver
{
    public static final String ACTION_ADD_REPETITION =
        "com.simpletool.goodhabit.ACTION_ADD_REPETITION";

    public static final String ACTION_DISMISS_REMINDER =
        "com.simpletool.goodhabit.ACTION_DISMISS_REMINDER";

    public static final String ACTION_REMOVE_REPETITION =
        "com.simpletool.goodhabit.ACTION_REMOVE_REPETITION";

    public static final String ACTION_TOGGLE_REPETITION =
        "com.simpletool.goodhabit.ACTION_TOGGLE_REPETITION";
